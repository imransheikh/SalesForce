Feature: Verifying the AAO End to End scenario for Monthly Goals Flow for officers with title AEO III.
...
And For Monthly Goals Flow set  Title for "AAO File Clerk" as "AEO III" and Form weight for "I-130" as "3.00"
And For Monthly Goals Flow update Title for "AAO Officer" as "AEO III"
...
|Item Type|Office|Officer Comments|Supervisor Comments|Supervisor|Editor|Contact|Account|Business|Attorney|Internal Contact|      
 ...
 @AAOGoals
 Scenario: Add internal contact and issue the SI.Verify the aao officer gets 1 point and it is updated on the monthly goal record
...
#Scenario:Update Production Expectations.verify the sum is equal to the total of the expectations entered.Update goals.Verify the sum is equal to the total of the goals entered.

#Then For Monthly Goals Flow update production expectations of "AAO Officer" for all the months to "8" and  verify the sum is total of all the expectations

#And For Monthly Goals Flow update goals of "AAO Officer" for all the months to "9" and  verify the sum is total of all the goals
